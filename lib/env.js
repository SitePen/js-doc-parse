define([
	...
	'./env/amd',
	'exports'
], function (lang, Scope, File, Value, Module, standardEnv, amdEnv, exports) {
	var globalScope = new Scope();

	// TODO: Is this really a correct statement?
	globalScope.isFunctionScope = true;

	// Using a non-enumerable mixin function so that we don't see environment variables in the scope output during
	// debugging/enumeration of global scope.
	// TODO: Use the correct environment loader. The global object thing especially belongs to the environment.
	globalScope.vars = (function nonEnumerableMixin(object) {
		...
		return object;
	}({}, standardEnv, amdEnv, { window: new Value({ type: Value.TYPE_OBJECT }) }));
	...
	return lang.mixin(exports, {
		...
		/**
		 * Parser state, used to provide more useful information in console logs.
		 * @type Object
		 */
