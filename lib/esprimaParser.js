define([
	...
	function createFunctionValue(/**Node*/ fn) {
		...
		// Allow for O(1) lookups of parameters by name elsewhere
		for (var i = 0, parameter; (parameter = functionValue.parameters[i]); ++i) {
			functionValue.parameters[parameter.name] = parameter;
		}
